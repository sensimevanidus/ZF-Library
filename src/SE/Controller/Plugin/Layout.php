...
/**
 * Registers each module's layouts.
 *
 * @author Suleyman Melikoglu <suleyman@melikoglu.info>
 */
class SE_Controller_Plugin_Layout extends Zend_Controller_Plugin_Abstract {
